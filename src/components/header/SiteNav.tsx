  ...
  render() {
    ...
    return (
      <>
          ...
          <SiteNavLeft className="site-nav-left">
            ...
            <SiteNavContent css={[this.state.showTitle ? HideNav : '']}>
              <ul css={NavStyles} role="menu">
                ...
                <li role="menuitem">
                  <Link to="https://www.facebook.com/BackstoryPodcast" activeClassName="nav-current">
                    Backstory Podcast
                  </Link>
                </li>
                <li role="menuitem">
                  <Link to="https://www.facebook.com/BaldwinCountyLegalEagle" activeClassName="nav-current">
                    BCLE
                  </Link>
                </li>
                <li role="menuitem">
        ...
        {isHome &&(
        <p>Advocates: Paul Ripp, Rebecca Chambless, Harry Still, Anne Deep</p>
        )}
      </>
    );
  }
